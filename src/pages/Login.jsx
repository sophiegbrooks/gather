    ...
    <div className="min-h-screen bg-mist flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        {mode === 'login' ? (
          ...
          <>
            <h1 className="text-3xl font-bold text-ink mb-1">Create an account</h1>
            <p className="text-slate-400 mb-8">Save your events and manage them from your profile.</p>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3.5 bg-gather-600 text-white font-semibold rounded-xl disabled:opacity-30 disabled:cursor-not-allowed hover:bg-gather-700 transition-all flex items-center justify-center gap-2 shadow-md shadow-gather-100"
              >
