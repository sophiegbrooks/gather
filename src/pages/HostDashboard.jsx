...
function heatColor(pct) {
  ...
  // Interpolate from light sage (#c8d9c4) to deep sage (#3d5a38)
  const r = Math.round(200 + (61  - 200) * pct)
  const g = Math.round(217 + (90  - 217) * pct)
  const b = Math.round(196 + (56  - 196) * pct)
  return `rgb(${r},${g},${b})`
}
